...
public class UserResponse {
    ...
    public UserResponse(String cdgUserName, String dscApellido, String dscEmail, String dscImagen, String dscNombre, LocalDateTime fchModificacion, LocalDateTime fchRegistro, String flgActivo, List<RolesResponse> roles) {
