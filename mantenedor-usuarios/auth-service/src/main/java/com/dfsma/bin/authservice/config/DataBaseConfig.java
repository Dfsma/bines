package com.dfsma.bin.authservice.config;
...
@Configuration
@EntityScan("com.dfsma.bin.authservice.entity")
@EnableJpaRepositories(entityManagerFactoryRef = "oracleEntityManagerFactory",
        transactionManagerRef = "oracleTransactionManager",
        basePackages = "com.dfsma.bin.authservice.repository")
...
public class DataBaseConfig {
    ...
    public LocalContainerEntityManagerFactoryBean secondEntityManagerFactory(final EntityManagerFactoryBuilder builder,
        ...
        return builder.dataSource(dataSource).packages("com.dfsma.bin.authservice.entity")
